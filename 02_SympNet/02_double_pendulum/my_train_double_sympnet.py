...
# --- Architecture choice (match style to pendulum SympNet) ---
hidden_layers = 2
hidden_dim = 60
...
# --- Data loading ---
os.makedirs('NeuralNets/DoublePendulum_SYMPNET', exist_ok=True)
...
# --- Define SympNet layer (same style as pendulum) ---
...
torch.save(model.state_dict(), 'NeuralNets/DoublePendulum_SYMPNET/sympnet_model.pt')
np.savetxt('NeuralNets/DoublePendulum_SYMPNET/loss.txt', loss_history)
...
pred_df.to_hdf('NeuralNets/DoublePendulum_SYMPNET/sympnet_predictions.h5', key='preds', mode='w')
print("Double Pendulum SympNet training and prediction finished.")