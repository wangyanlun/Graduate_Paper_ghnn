...
torch.save(model.state_dict(), 'NeuralNets/HenonHeiles_MLP_OOD/mlp_model.pt')
...
pd.DataFrame(pred_rows).to_hdf(
    'NeuralNets/HenonHeiles_MLP_OOD/mlp_rollout_0_50.h5',
    key='preds',
    mode='w'
)
print("Saved rollout predictions to NeuralNets/HenonHeiles_MLP_OOD/mlp_rollout_0_50.h5")
