...
| 系统 | 维度 | 哈密顿量类型 |是否可分裂| 特点 |
|------|------|-------------|---------|------|
| **单摆（Pendulum）** | 2D (q, p) | 可分 | 可分 | 简单周期系统，基础验证 |
| **双摆（Double Pendulum）** | 4D (q₁, q₂, p₁, p₂) | 非可分 | 非可分 | 混沌系统，测试非可分哈密顿近似能力 |
| **Hénon-Heiles 系统** | 4D (x, y, pₓ, pᵧ) | 非可分 | 可分 | 经典混沌系统，极端分布外泛化测试 |
